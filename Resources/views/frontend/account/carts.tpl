        ...
        {else}
            {block name="frontend_account_carts_list"}
                {foreach $froshSavedCarts as $cart}
                    <div class="carts-list-element">
                        {block name="frontend_account_carts_list_product_box"}
                            <div class="carts-list-element-names">
                                {foreach $cart->getItems() as $item}
                                    {if !$item->getProduct()}
                                        {continue}
                                    {/if}

                                    <div class="carts-list-element-name">
                        ...
                        {block name="frontend_account_carts_list_action"}
                            <div class="carts-list-element-actions">
